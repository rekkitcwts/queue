...
<div id="header">
  ...
  <div id="main-menu">
   <ul>
	  ...
	  <!-- Tab thingies. -->
      <li><a href="<?php echo base_url()?>index.php/login" ><span>Staff</span></a></li>
      <li><a href="<?php echo base_url()?>index.php/queue_home/user" class="active"><span>Customer</span></a></li>
